...
- Added restart GXAI button in clearing tab
...
- Full new h5 model for detector, trained by me - https://github.com/gnilobaiter/Classificator_HUMAN_VS_AI
- QOL fixes
## 1.12.x
...
- Fixed bug with tmp.png in GXAI/.. folder
- Gradio update
